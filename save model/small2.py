...
parser.add_argument("--input_dir", default='data/cartoon_gcl3', help="path to folder containing images")
parser.add_argument("--mode", default='test', choices=["train", "test", "export"])
parser.add_argument("--output_dir", default='small/color4_test', help="where to put output files")
parser.add_argument("--seed", type=int)
parser.add_argument("--checkpoint",default='small/color4',help="directory with checkpoint to resume training from or use for testing")
